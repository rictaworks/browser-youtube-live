...
CREATE TABLE IF NOT EXISTS "users" ("id" uuid NOT NULL PRIMARY KEY, "email" varchar NOT NULL, "name" varchar NOT NULL, "google_id" varchar NOT NULL, "youtube_token" text, "token_expiry" datetime(6), "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL);
